...
--
-- Table structure for table sqlt_queries
--

DROP TABLE IF EXISTS sqlt_queries;
CREATE TABLE sqlt_queries (
...
--
-- Dumping data for table sqlt_queries
--

INSERT INTO `sqlt_queries` (`statement`, `formulation`, `questionnumber`)
VALUES
...
--
-- Table structure for table sqlt_users
--

DROP TABLE IF EXISTS sqlt_users;
CREATE TABLE sqlt_users (
...
--
-- Table structure for table sqlt_results
--

DROP TABLE IF EXISTS sqlt_results;
CREATE TABLE sqlt_results (
  ...
  CONSTRAINT resreq FOREIGN KEY (fkqueries) REFERENCES sqlt_queries (idqueries) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT resus FOREIGN KEY (fkuser) REFERENCES sqlt_users (idusers) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=587 DEFAULT CHARSET=utf8;

INSERT INTO sqlt_users (lastname, firstname, intranetid)
VALUES
('APOTHELOZ','Yann',2274),
('BARDI','Sadam',6484),
...
-- -----------------------------------------------------
-- Below is the database used to run the submitted queries
-- -----------------------------------------------------
